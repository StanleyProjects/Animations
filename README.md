...
- [Maven](https://s01.oss.sonatype.org/content/repositories/snapshots/com/github/kepocnhh/Animations/0.1.0u-SNAPSHOT)
...
dependencies {
    implementation("com.github.kepocnhh:Animations:0.1.0u-SNAPSHOT")
}
```
